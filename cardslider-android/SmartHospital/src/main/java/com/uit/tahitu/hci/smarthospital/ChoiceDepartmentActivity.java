...
public class ChoiceDepartmentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topBar.setOnLeftRightClickListener(new CustomViewTopBar.OnLeftRightClickListener() {
            ...
            public void onRightClicked() {
                ...
                getIntent().putStringArrayListExtra("ListKhoa",mList);
